...
class ProcesamientoPorLotesApp:
    ...
    def crear_lotes(self):
        ...
        self.lotes_pendientes = len(self.lotes) - 1  # Solo los pendientes
    ...
    def ejecutar_procesos(self):
        if self.lotes:
            ...
            self.procesos = lote  # Actualizamos el lote actual
            self.procesos_pendientes = len(lote)
            self.mostrar_procesos_en_espera()
            while self.procesos:
    ...
    def ejecutar_proceso(self, proceso):
        ...
        self.listbox_ejecucion.delete(0, tk.END)
        # Elimina el proceso actual utilizando pop
        self.procesos.pop(0)
        self.procesos_pendientes -= 1
        self.mostrar_procesos_en_espera()  # Actualizar vista del lote actual
